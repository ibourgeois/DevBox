...
echo "	DocumentRoot /var/www/rubyonrails/public" >> /etc/apache2/sites-enabled/000-default
...
echo "	</Directory>" >> /etc/apache2/sites-enabled/000-default
echo "	<Directory /var/www/rubyonrails/public/>" >> /etc/apache2/sites-enabled/000-default
...
echo "        DocumentRoot /var/www/rubyonrails/public" >> /etc/apache2/sites-available/default
...
echo "        </Directory>" >> /etc/apache2/sites-available/default
echo "        <Directory /var/www/rubyonrails/public/>" >> /etc/apache2/sites-available/default
...
# Set up the database
echo "CREATE DATABASE IF NOT EXISTS rubyonrails" | mysql
echo "CREATE USER 'vagrant'@'localhost' IDENTIFIED BY 'vagrant'" | mysql
echo "GRANT ALL PRIVILEGES ON rubyonrails.* TO 'vagrant'@'localhost' IDENTIFIED BY 'vagrant'" | mysql
