...
sudo sed -i "s|'database'  => '', |'database'  => 'laravel',|g" /vagrant/laravel/app/config/database.php
sudo sed -i "s|'username'  => '', |'username'  => 'vagrant',|g" /vagrant/laravel/app/config/database.php
